...
![[Pasted image 20250115210035.png|400]]

2. Clicca su `Download ZIP`

![[Pasted image 20250115210258.png|400]]
...
### 3.0.1 Elementi in comune dei grafici
...
![[visualization.png]]
	3. Vecchio Area Chart con tutte le fonti di energia, in particolare è rappresentata ltalia
...
### 3.7 Bar Chart Produzione + Database
Dopo aver osservato come una singola nazione produce la propria energia elettrica guardando alle macro-categorie, il passaggio successivo non può essere che entrare nel dettaglio. Questo compito è svolto da un bar plot a cui è stato affiancato una tabella contente il totale di energia prodotta per ogni tipo di fonte (vedere sezione *3.1 Dataset Produzione*) dato un anno (selezionato dallo slide ad inizio pagina). L’idea originale consisteva in un grafico più organico ispirato dal seguente:

![[Pasted image 20250115150243.png]]
4. Bar plot sulla produzione di energia dal sito https://www.iea.org/regions/europe/electricity
...
![[Screenshot 2025-01-11 011334.png]]
	5. Barplot e barra inferiore unite usando vconcat di altair (https://altair-viz.github.io/user_guide/compound_charts.html#vertical-concatenation)
